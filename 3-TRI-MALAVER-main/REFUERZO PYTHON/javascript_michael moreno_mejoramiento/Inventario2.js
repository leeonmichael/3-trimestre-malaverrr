...
function crearProductoElectronico(nombre, precio, cantidad, garantiaMeses) {
  const michael_moreno2 = crearProducto(nombre, precio, cantidad);
  return {
    ...michael_moreno2,                 
    garantiaMeses,              
    categoria: "ElectrÃ³nico"     
  };
}
...
function agregarProducto(inventario, michael_moreno2) {
  return [...inventario, michael_moreno2]; 
}
...
const electronicos = buscarPorCategoria(inventario, "ElectrÃ³nico");
